...
Durante il training, la rete utilizza una topologia multi-branch complessa (simile a ResNet/Inception), che facilita la propagazione dei gradienti e la convergenza. Durante l'inferenza, grazie alla linearità delle convoluzioni, i rami paralleli vengono matematicamente fusi in un unico kernel $3 \times 3$.
