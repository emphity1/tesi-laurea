...
\paragraph{Nota sulla Validazione.}
In accordo con la prassi comunemente adottata in letteratura per CIFAR-10~\cite{he2016deep}, il test set è stato utilizzato come criterio di selezione del modello migliore (early stopping sulla best accuracy). Formalmente, questo introduce una forma di information leakage; tuttavia, data la stabilità dei risultati osservata e l'ampia adozione di questa pratica nei lavori di riferimento, riteniamo il bias introdotto trascurabile ai fini delle conclusioni presentate.
