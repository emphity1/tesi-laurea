"""
Modello C: MobileNetECA-Rep (ECA + Structural Reparameterization)
Aggiunge RepConv (multi-branch training → single-branch deploy) ai blocchi.
"""
import sys, os
...
if __name__ == "__main__":
    ...
    run_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "results_C_eca_rep")
    setup_logging(run_dir)

    logging.info("=" * 60)
    logging.info("MODELLO C: MobileNetECA-Rep (ECA + Reparameterization)")
    logging.info("=" * 60)
