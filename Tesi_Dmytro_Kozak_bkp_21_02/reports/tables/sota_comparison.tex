...
\begin{table}[h]
    ...
    \begin{tabular}{l l c c c c}
        ...
        MobileNetV2 (0.5x)$^\dagger$ & Efficient & 92.06\% & 0.70M & 25.3M & \cite{sandler2018mobilenetv2} \\
        ...
        \textbf{MobileNetECA-Rep (Ours)} & \textbf{Hybrid} & \textbf{93.76\%} & \textbf{0.06M} & \textbf{9.4M} & This Work \\
        \bottomrule
    \end{tabular}
    }
    \vspace{2pt}
