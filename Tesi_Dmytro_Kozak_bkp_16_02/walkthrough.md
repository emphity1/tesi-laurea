...
- [x] **Chapter 6 (Results):** Added empirical latency analysis (AMD Threadripper) and misclassification analysis (Figure 6.7).
- [x] **Final Compilation:**
    - [x] Fixed "itemize" error in Ch6.
    - [x] Fixed "Table of Contents" visibility (fixed hyperref/hypcap conflict).
    - [x] Verified full PDF generation (54 pages).
