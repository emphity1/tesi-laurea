...
In questa appendice riportiamo i valori dettagliati di Precision, Recall e F1-Score per ciascuna delle 10 classi del dataset CIFAR-10, ottenuti dal miglior modello \textit{MobileNetECA-Rep-AdvAug}.
