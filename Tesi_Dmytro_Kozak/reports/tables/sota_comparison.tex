...
\begin{table}[h]
    ...
    \begin{tabular}{l l c c c c}
        ...
        MobileNetV2 (0.5x)$^\dagger$ & Efficient & 92.88\% & 0.70M & 27.97M & \cite{sandler2018mobilenetv2} \\
        MobileNetV2 (1.0x)$^\dagger$ & Efficient & 93.79\% & 2.24M & 87.98M & \cite{sandler2018mobilenetv2} \\
        MobileNetV3-Small & Efficient & 92.97\% & 2.54M & 60M & \cite{howard2019searching} \\
        ShuffleNetV2 (0.5x)$^\dagger$ & Efficient & 90.13\% & 0.35M & 10.90M & \cite{ma2018shufflenet} \\
        GhostNet (ResNet-56) & Efficient & 93.38\% & 0.43M & 63M & \cite{han2020ghostnet} \\
        RepVGG-A0$^\dagger$ & Rep & 94.39\% & 7.84M & 489.08M & \cite{ding2021repvgg} \\
