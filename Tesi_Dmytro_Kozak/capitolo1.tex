...
\begin{enumerate}
    ...
    L'ultimo step evolutivo ha riguardato l'addestramento con tecniche di \textit{Advanced Data Augmentation} (AutoAugment + Random Erasing), portando il modello finale (\textbf{MobileNetECA-Rep-AdvAug}) a raggiungere il \textbf{93.23\%} di accuratezza sul test set, un risultato eccezionale per la sua classe di dimensione.
\end{enumerate}
