...
\begin{enumerate}
    ...
    L'ultimo step evolutivo ha riguardato l'addestramento con tecniche di \textit{Advanced Data Augmentation} (AutoAugment + Random Erasing), portando il modello finale (\textbf{MobileNetECA-Rep-AdvAug}) a superare la soglia del \textbf{93.5\%} di accuratezza, un risultato eccezionale per la sua classe di dimensione.
\end{enumerate}
