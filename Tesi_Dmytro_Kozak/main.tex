...
\begin{abstract}
    ...
    Il modello proposto, MobileNetECA-Rep, raggiunge un'accuratezza del 93.23\% sul dataset CIFAR-10 utilizzando meno di 80k parametri, dimostrando un eccellente trade-off Accuracy/FLOPs.
