...
\begin{abstract}
    ...
    Il modello proposto, MobileNetECA-Rep-AdvAug, raggiunge un'accuratezza del 93.76\% sul dataset CIFAR-10 utilizzando circa 62k parametri, dimostrando un eccellente trade-off Accuracy/FLOPs.
