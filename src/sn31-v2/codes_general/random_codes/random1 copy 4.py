...
# Define ResidualNode used in EvoNetwork
...
# Define ResidualPhase used in EvoNetwork
...
class DummyTrainer:
    def __init__(self, epochs=50, batch_size=128, learning_rate=0.001, weight_decay=1e-4, cutout_length=16):
        self.epochs = epochs
