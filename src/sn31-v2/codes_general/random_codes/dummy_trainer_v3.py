...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = DepthwiseSeparableConv(3, 8)
        self.bn1 = nn.BatchNorm2d(8)
        self.conv2 = DepthwiseSeparableConv(8, 16)
        self.bn2 = nn.BatchNorm2d(16)
        self.conv3 = DepthwiseSeparableConv(16, 32)
        self.bn3 = nn.BatchNorm2d(32)
        self.conv4 = DepthwiseSeparableConv(32, 64)
...
class DummyTrainer:
    def __init__(self, epochs=100, batch_size=128, learning_rate=0.01, momentum=0.9, weight_decay=3e-4, cutout_length=16):
        self.epochs = epochs
