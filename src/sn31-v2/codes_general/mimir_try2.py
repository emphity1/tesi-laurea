...
class DummyTrainer:
    def __init__(self, model_path='/workspace/BESTMODELS/models/model1.pt', epochs=50, batch_size=512, base_lr=0.001, max_lr=0.01, weight_decay=1e-4, cutout_length=16):
        self.epochs = epochs
