...
class DummyTrainer:
    def __init__(self, epochs=50, batch_size=128, learning_rate=0.01, momentum=0.9, weight_decay=3e-4, cutout_length=16):
        self.epochs = epochs
        ...
        self.best_accuracy = 0.0  # Inizializzare best_accuracy
