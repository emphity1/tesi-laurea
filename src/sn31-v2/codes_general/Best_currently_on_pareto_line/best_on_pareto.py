...
class ResNetLight(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.in_channels = 36  # Start with 36 channels
        self.conv1 = nn.Conv2d(3, 36, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(36)
        self.layer1 = self._make_layer(36, 2, stride=1)  # Keep 2 blocks
        self.layer2 = self._make_layer(72, 2, stride=2)  # Increased from 64 to 72
        self.layer3 = self._make_layer(128, 2, stride=2)  # Increased from 128 to 128
