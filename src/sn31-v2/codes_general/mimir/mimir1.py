...
#Accuracy of the network on the 10000 test images: 91.45%
#2024-07-01 21:46:59.838 |       INFO       | 🖥️ Params: 700282  
...
class SEBlock(nn.Module):
    def __init__(self, channel, reduction=22):
...
class ResNetLight(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer1 = self._make_layer(32, 2, stride=1)  # Reduced from 3 to 2 blocks
        self.layer2 = self._make_layer(64, 2, stride=2)  # Reduced from 3 to 2 blocks
        self.layer3 = self._make_layer(128, 2, stride=2)  # Reduced from 3 to 2 blocks
        self.linear = nn.Linear(128, num_classes)  # Adjusted to match the final layer output
