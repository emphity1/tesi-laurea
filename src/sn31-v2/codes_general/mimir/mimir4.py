...
class DummyTrainer:
    def __init__(self, epochs=50, batch_size=2500, base_lr=0.005, max_lr=0.025, weight_decay=1e-4, cutout_length=16, smoothing=0.1):
        self.epochs = epochs
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(self.trainloader, 0):
                ...
                inputs, targets_a, targets_b, lam = self.mixup_data(inputs, labels, alpha=1.0)
