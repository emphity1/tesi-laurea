...
class ResNetLight(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer1 = self._make_layer(16, 3, stride=1)  # Increase depth
        self.layer2 = self._make_layer(32, 3, stride=2)  # Increase depth
        self.layer3 = self._make_layer(64, 3, stride=2)  # Increase depth
...
class DummyTrainer:
    def __init__(self, epochs=50, batch_size=3000, base_lr=0.001, max_lr=0.01, weight_decay=4e-4, cutout_length=16, smoothing=0.1):
        self.epochs = epochs
