...
### SAME CODE BUT DIFFERENT PARAMETERS
class Cutout(object):
...
class ResNetLight(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.in_channels = 64  # Inizia con 64 canali
        self.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(64)
        self.layer1 = self._make_layer(64, 3, stride=1)  # Aumenta a 3 blocchi
        self.layer2 = self._make_layer(128, 4, stride=2)  # Aumenta a 128 canali e 4 blocchi
        self.layer3 = self._make_layer(256, 6, stride=2)  # Aumenta a 256 canali e 6 blocchi
        self.linear = nn.Linear(256, num_classes)  # Adattato per il layer finale
...
class DummyTrainer:
    def __init__(self, model_path='/workspace/BESTMODELS/models/model_geordion6.pt', epochs=50, batch_size=2048, base_lr=0.001, max_lr=0.01, weight_decay=1e-4, cutout_length=16):
        self.epochs = epochs
