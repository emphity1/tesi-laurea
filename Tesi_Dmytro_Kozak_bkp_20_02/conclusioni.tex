...
\begin{enumerate}
    ...
    \item \textbf{Validazione sperimentale}: Allenamento del modello ottimizzato per 200 epoche con SGD+momentum e Cosine Annealing schedule, raggiungendo un'accuratezza finale di \textbf{93.23\%} sul test set CIFAR-10, superando le baseline standard.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Accuratezza}: 93.23\% su CIFAR-10 test set.
